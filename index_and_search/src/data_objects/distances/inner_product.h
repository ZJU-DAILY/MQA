...
#ifndef INDEXING_AND_SEARCH_INNER_PRODUCT_H
#define INDEXING_AND_SEARCH_INNER_PRODUCT_H

#include "../../../CGraph/src/CGraph.h"

template<typename TVec = int, typename TRes = TVec, const bool needSqrt = false, const bool needSkip = true>
class InnerProduct : public CGraph::UDistance<TVec, TRes> {
public:
...
#endif //INDEXING_AND_SEARCH_INNER_PRODUCT_H
