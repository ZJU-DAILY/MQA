...
#ifndef INDEXING_AND_SEARCH_C3_NEIGHBOR_KGRAPH_H
#define INDEXING_AND_SEARCH_C3_NEIGHBOR_KGRAPH_H

class C3NeighborKGraph : public C3NeighborBasic {
public:
...
#endif //INDEXING_AND_SEARCH_C3_NEIGHBOR_KGRAPH_H
