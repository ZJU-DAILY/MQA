...
#ifndef INDEXING_AND_SEARCH_EVA_RECALL_NODE_H
#define INDEXING_AND_SEARCH_EVA_RECALL_NODE_H
...
public:
    ...
    CStatus run() override {
        ...
        for (unsigned i = 0; i < gt_num_; i++) {
            if (s_param->results_[i].empty()) continue;
...
#endif //INDEXING_AND_SEARCH_EVA_RECALL_NODE_H
