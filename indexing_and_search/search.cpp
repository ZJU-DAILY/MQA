...
int main(int argc, char **argv) {
    ...
    Params.set_search_param(modal1_base_path, modal2_base_path, modal1_query_path, modal2_query_path, res_path, top_k, index_path);
    ...
    } else if (strcmp(index_method, "NSG") == 0) {
