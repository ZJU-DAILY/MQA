//
// Created by MaouSanta on 2024/3/19.
//
...
int main(int argc, char **argv) {
    ...
    modal1_base_path.emplace_back(get_param(2, 0));
    modal1_query_path.emplace_back(get_param(3, 0));
    modal1_weight.emplace_back(1);
    is_norm_modal1.emplace_back(1);
    ...
    Params.set_candidate_top_k(1000); // number of result's candidates
